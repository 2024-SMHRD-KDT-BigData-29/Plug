...
<body>
    <div class="container">
        ...
        <div class="product-detail">
            <div class="product-card">
                <img src="images/iphone14promax.png" alt="아이폰 14 프로 맥스">
                <h3>Apple 아이폰14 프로 맥스</h3>
                <p>128GB</p>
                <p class="price">1,550,000원</p>
                <div class="grade-options">
                    <h4>구매하기</h4>
                    <p class="grade-price">등급별 아이폰14 프로 맥스 128GB</p>
    ...
    <script src="resources/assets/js/iphone14promax.js"></script>
</body>
</html>
