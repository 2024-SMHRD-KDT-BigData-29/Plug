...
<body>
    <div class="container">
        ...
        <div class="product-detail">
            <div class="product-card">
                <img src="images/galaxy22plus.jpg" alt="갤럭시 22 plus">
                <h3>Samsung 갤럭시 S22 plus </h3>
                <p>128GB</p>
                <p class="price">1,119,000원</p>
                <div class="grade-options">
                    <h4>구매하기</h4>
                    <p class="grade-price">등급별 갤럭시 S22 plus  128GB</p>
    ...
    <script src="resources/assets/js/galaxy22plus.js"></script>
</body>
</html>
