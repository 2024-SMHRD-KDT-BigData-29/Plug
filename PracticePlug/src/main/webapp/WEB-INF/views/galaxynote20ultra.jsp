...
<body>
    <div class="container">
        ...
        <div class="product-detail">
            <div class="product-card">
                <img src="images/galaxynote20ultra.jpg" alt="갤럭시 note20 울트라">
                <h3>Samsung 갤럭시 Note20 ultra</h3>
                <p>128GB</p>
                <p class="price">1,452,000원</p>
                <div class="grade-options">
                    <h4>구매하기</h4>
                    <p class="grade-price">등급별 갤럭시 Note20 ultra 128GB</p>
    ...
    <script src="resources/assets/js/galaxynote20ultra.js"></script>
</body>
</html>
