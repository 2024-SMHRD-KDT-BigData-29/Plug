...
<head>
    ...
    <title>구매페이지</title>
    <link rel="stylesheet" href="PLUG.css"> <!-- 공통 스타일 -->
    <link rel="stylesheet" href="resources/assets/css/iphone15promax.css"> <!-- 상세 페이지 전용 스타일 -->
</head>
<body>
    <div class="container">
        <!-- 상단 헤더 -->
        ...
        <div class="product-detail">
            <div class="product-card">
                ...
                <div class="grade-options">
                    <h4>구매하기</h4>
                    <p class="grade-price">등급별 아이폰15 프로맥스 128GB</p>
    ...
    <script src="resources/assets/js/iphone15promax.js"></script>
</body>
</html>
